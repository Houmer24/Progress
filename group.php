...
$q = $db->query('SELECT Name, Surname, Birth, Mail, Gruppa, Semest, Ball, Supervise, Exorcizm, Mithology, Necromancy, Zide, Aipi FROM Stud_list ORDER BY Gruppa DESC LIMIT 10');
	while ($row = $q->fetch()) {
